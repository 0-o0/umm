...
export const FilenamePolicies: { key: FilenamePolicy; text: string }[] = [
  { key: FilenamePolicy.ArtistAndTitle, text: 'Artist-Title' },
  { key: FilenamePolicy.TitleOnly, text: 'Title' },
  { key: FilenamePolicy.TitleAndArtist, text: 'Title-Artist' },
  { key: FilenamePolicy.SameAsOriginal, text: 'Same as Original' },
];
