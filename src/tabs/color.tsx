...
export function Nav() {
  ...
  const PaletteIcon = ({ tabIndex }: { tabIndex: number }) => (
    <motion.svg
      ...
      height="100%"
      viewBox="0 0 256 256"
      style={{ height: '1.5rem', width: '1.5rem', fontSize: '1rem', color: 'var(--text)', cursor: 'pointer', transition: 'color 0.2s ease' }}
      tabIndex={tabIndex}
      whileHover={{ translateY: '-2px', color: 'var(--color-primary)'}}
