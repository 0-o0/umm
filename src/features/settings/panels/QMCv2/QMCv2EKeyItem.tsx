    ...
    <ListItem mt={0} pt={2} pb={2} _even={{ bg: 'gray.50' }}>
      <HStack>
        ...
        <VStack flex={1}>
          <Input
            variant="flushed"
            placeholder="File name, including the file extension. For example, 'AAA - BBB.mflac'"
            value={name}
          ...
          <InputGroup size="xs">
            ...
            <Input
              variant="flushed"
              placeholder="Key, usually consisting of 364 or 704 characters without spaces."
              value={ekey}
